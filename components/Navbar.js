...
function Navbar() {
  return (
    <header className="">
      <nav className="fixed z-10 top-0 left-0 right-0 w-full bg-white backdrop-blur-md border-b border-zinc-200 py-5 pl-25 flex items-center justify-between">
        <div className="flex items-center space-x-11">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem value="light">Bus</SelectItem>
              <SelectItem value="dark">Taxi</SelectItem>
              <SelectItem value="system">Rental Cars</SelectItem>
            </SelectContent>
          </Select>
        </div>
      ...
      <ul className="flex items-center justify-center font-medium space-x-6">
        <li className="relative group cursor-pointer">
          <Link href="/" className="group-hover:text-green-900 transition-colors duration-300">
            Home
        ...
        <li className="relative group cursor-pointer">
          <Link href="/service" className="group-hover:text-green-900 transition-colors duration-300">
            Service
            <span className="block h-[2px] w-full bg-green-900 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></span>
          </Link>
        </li>
        <li className="relative group cursor-pointer">
          <Link href="/contact" className="group-hover:text-green-900 transition-colors duration-300">
            Contact
            <span className="block h-[2px] w-full bg-green-900 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></span>
          </Link>
        </li>
