...
export default function Footer() {
  return (
    <footer className="bg-[url(/bg-astron.png)] bg-cover text-zinc-950 px-6 py-10">
      <div className="max-w-6xl flex justify-between items-center mx-auto">
        ...
        <div>
          ...
          <Link href="/" className="group-hover:text-green-900 text-lg transition-colors duration-300">
            FAQs
        ...
        <div>
          <ul className="space-y-1 text-sm hover:cursor-pointer">
          <li className="relative group cursor-pointer">
          <Link href="/" className="group-hover:text-green-900 text-lg transition-colors duration-300">
            About
            <span className="block h-[2px] w-full bg-green-900 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center"></span>
      ...
      <div className="flex w-full justify-center items-center">
        <p className="text-sm text-zinc-950">© Copyright. All rights reserved.</p>
      </div>
    </footer>
  );
}
